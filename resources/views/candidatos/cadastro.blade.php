            ...
            <div class = "col m12 s12 l12 card-panel">    
                ...
                <div class = "row">
                    <div class = "input-field col s12 m12 l4">
                        ...
                        <input id = "campoNome" type = "text" name = "nome" value = "{{$candidato['nome'] or old('nome') }}" 
                    ...
                    <div class = "input-field  col s6 m3 l2">
                        ...
                        <input id = "campoNascimento" name = "nascimento" 
                               type = "text" value = "{{ isset($candidato['cpf']) ? app('transformador')->converterStringDateTimeParaDataBrasileira($candidato['nascimento']) : old('nascimento')}}"
                    ...
                    <div class = "input-field col s6 m3 l2">
                        ...
                        <input id = "campoTelefoneResidencial" type = "text" 
                               name = "telefone_residencial" value = "{{ isset($candidato['telefone_residencial']) ? app('transformador')->adicionarMascaraTelefone($candidato['telefone_residencial']) : old('telefone_residencial')}}"
                    ...
                    <div class = "input-field col s6 m3 l2">
                        ...
                        <input id = "campoRG" type = "text" name = "rg"  value = "{{$candidato['rg'] or old('rg')}}" 
                    ...
                    <div class = "input-field col s12 m3">
                        ...
                        <input id = "campoRGData" name = "rg_data_expedicao" type = "text" value = "{{ isset($candidato['rg_data_expedicao']) ? app('transformador')->converterStringDateTimeParaDataBrasileira($candidato['rg_data_expedicao']) : old('rg_data_expedicao')}}"
                    ...
                    <div class = "input-field col s12 m4 l2">
                        ...
                        <input id = "campoCEP" name = "cep" type = "text" value = "{{ isset($candidato['cep']) ? app('transformador')->adicionarMascaraCEP($candidato['cep']) : old('cep')}}"
                               <?= $errors->has('cep') ? "class = 'validate invalid'" : '' ?> >
                    </div>
                    <div class = "input-field col s12 m3 l2">
                        <label for = "campoBairro">Bairro</label>
                        <input id = "campoBairro" name = "bairro" type = "text" value = "{{$candidato['bairro'] or old('bairro')}}"
                    ...
                    <div class = "input-field col s8 m4 l3">
                        ...
                        <input id = "campoLogradouro" name = "logradouro" type = "text" value = "{{$candidato['logradouro'] or old('logradouro')}}" 
                               <?= $errors->has('logradouro') ? "class = 'validate invalid'" : '' ?>>
                    </div>
                    <div class = "input-field col s4 m2">
                        <label for = "campoNumero">Número</label>
                        <input id = "campoNumero" name = "numero" type = "text" value = "{{$candidato['numero'] or old('numero')}}"
                               <?= $errors->has('numero') ? "class = 'validate invalid'" : '' ?>>
                    </div>
                    <div class = "input-field col s12 l3">
                        <label for = "campoEmail">E-mail</label>
                        <input id = "campoEmail" type = "text" name = "email" value = "{{$candidato['email'] or old('email')}}" 
